...
!***********************************************************************
!
      subroutine lshbiv_acc(x,y,nmes,xll,it,nsub,beta,nest,nilev,quad, &
                            nm,score,hess,ncov,flag,ifail,maxcol,link, &
                            risk,corr,iter,cflag,step,scnorm,scores, &
                            n1lev,family,norms,ind,xil,sign,iquad,aquad, &
...
!$OMP SHARED(rowind,it,family,y,theta,x,offlag,offpos,risk,n1lev,link), &
!$OMP SHARED(flag,scores,z1,z2,sflag,xil,sign,norms,corr,nmes), &
