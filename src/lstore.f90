...
!***********************************************************************
!
      subroutine lstore(x,y,nmes,xll,it,nsub,beta,nest,nilev,quad,nm, &
                        score,hess,ncov,flag,ifail,maxcol,link,risk, &
                        corr,iter,cflag,step,scnorm,scores,n1lev,n2lev, &
                        family,ind,xil,sign,iquad,aquad,mus,taus,offlag, &
                        offpos,ncat,maxcat)
...
!     case
      ...
      character(len=5) :: str
      double precision theta(maxpar),thetanir,qprob(3,256),e2,r,e2s(3), &
...
!$OMP SHARED(ic,z1,z2,sflag,xil,sign,risk,n1lev,n2lev,corr,nmes,ncut), &
!$OMP SHARED(ncat,c,nic1,nic2,nic3), &
