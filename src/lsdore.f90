...
!***********************************************************************
!
      subroutine lsdore(x,y,nmes,xll,it,nsub,beta,nest,nilev,quad,nm, &
                        score,hess,ncov,flag,ifail,offlag,offpos,maxcol, &
                        link,iter,cflag,step,scnorm,scores,ncat,ind,xil, &
                        sign,iquad,aquad,mus,taus,maxcat,risk)
...
!     case
      ...
      character(len=5) :: str
      double precision theta(maxpar),e2,r,b,pi,bb,meansc(maxpar), &
