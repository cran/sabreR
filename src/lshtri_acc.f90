...
!***********************************************************************
!
      subroutine lshtri_acc(x,y,nmes,xll,it,nsub,beta,nest,nilev,quad, &
                            nm,score,hess,ncov,flag,ifail,maxcol,link, &
                            risk,corr,iter,cflag,step,scnorm,scores, &
                            n1lev,family,n2lev,norms,ind,xil,sign,iquad, &
...
!$OMP SHARED(rowind,it,nmes,family,y,n1lev,theta,x,offlag,offpos,xil), &
!$OMP SHARED(n2lev,norms,corr,link,flag,scores,ic,z1,z2,sflag,sign), &
