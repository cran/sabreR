...
!-----------------------------------------------------------------------
      ...
      integer ierror
!-----------------------------------------------------------------------
!     Main program calls mpi_init and then the remainder of Sabre to try
...
!-----------------------------------------------------------------------
      ...
      character(len=3) :: limit_names(4) = &
                           (/ 'dat', 'obs', 'var', 'par' /)
      character(len=82) :: argstring, tempstring
      character(len=20) :: nextarg
      character(len=80) :: input_file, arg_value
      double precision, allocatable :: x(:), beta(:)
      integer istat, limits(4), iarg, nargs, iargc, length, ch, iostat, &
              ivalue, equals_position
